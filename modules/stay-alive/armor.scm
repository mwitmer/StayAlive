...
(define-objects Armor 
  ...
  ((Shield 
    ...
    ((Buckler
      ((name "buckler")
       (describe-long "A handy little shield that \
can block a sword blow but won't do you much good versus slings and arrows.")))))
   (BodyArmor 
    ((wear-requires 
      (h (quantity 1)
    ...
    ((LeatherArmor 
      ((name '("suit of leather armor" "suits of leather armor"))
       (describe-long "A thing layer of animal skin that \
doesn't seem to protect you from much.")))))
